...
public class TicTacToeServer extends JFrame {
   ...
   public boolean isGameOver()
   {
      ...
      { winner = X_MARK;
         return true;  // this is left as an exercise
      }
      ...
      if( board[6] == X_MARK && board [ 4 ] == X_MARK && board [ 2 ] == X_MARK)
      { winner = X_MARK;
         return true;
      }
      //....horizontal wins O Player
      ...
      if( board[6] == O_MARK && board [ 4 ] == O_MARK && board [ 2 ] == O_MARK)
      {  winner = O_MARK;
         return true;
      }
   ...
   private class Player extends Thread {
      ...
      public void otherPlayerMoved( int location )
      {
         ...
         if(isGameOver()){
            try {
               output.writeUTF( "Winner is "+ winner );
